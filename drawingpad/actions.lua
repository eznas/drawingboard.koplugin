    ...
    UIManager:scheduleIn(0.01, function()
        ...
        UIManager:scheduleIn(0.5, function()
            ...
            if ok2 and saved2 then
                ...
                components.showToast(_("保存失败,请检查目录权限:") .. "\n" .. dir)
            end
        end)
    end)
end
